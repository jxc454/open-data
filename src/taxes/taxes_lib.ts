...
export function validateTaxes(input: {meta: object, data: [object]}): void {
    const expected = [
        ...
        'propertyid','block','lot','ward','sect','propertyaddress','lotsize','citytax','statetax','rescode',
        'amountdue','asofdate','neighborhood','policedistrict','councildistrict','location',
        ':@computed_region_5kre_ccpb',':@computed_region_gwq4_fjxs',':@computed_region_s6p5_2pgr'
    ];
